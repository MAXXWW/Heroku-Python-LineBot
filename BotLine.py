...
line_bot_api = LineBotApi(
    '/xbCbh5NvGPyYwIrTLURI2Qv9TehSw5RtOh9A4L+ZJAT6AfZmgLY+/+goembBsVd4wXTGefsAsZCGEiYEvtNKdm/cPo7aXkFZ5OR21/zBRuiNXJtgvejHP9V50JL0VWcgjFnLYg76X+IO+1yycnN0wdB04t89/1O/w1cDnyilFU=')
handler = WebhookHandler('64c9defc1c1d0f812d7af8ce25afb3d0')
...
def bc(PESAN):
    ...
    if(PESAN == "!bc-text"):
        ...
        if(cursor_broadcast.rowcount == 0):
            ...
            users = "U1c2b7166870b441986d3cdb48a92eea3"
            for data in results:
